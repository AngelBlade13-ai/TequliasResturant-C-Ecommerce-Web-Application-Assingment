...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
            ...
            new Product { ProductId = 2, Name = "Chicken Tacos", Description = "Grilled chicken tacos with lettuce, pico de gallo, crema, and cotija cheese.", Price = 8.49m, Stock = 70, CategoryId = 2, ImageUrl = "/images/menu/chicken-tacos.png" },
            new Product { ProductId = 3, Name = "Baja Fish Tacos", Description = "Crispy fish tacos with cabbage slaw, lime crema, pico de gallo, and salsa verde.", Price = 9.99m, Stock = 45, CategoryId = 2, ImageUrl = "/images/menu/fish-tacos.png" },
            ...
            new Product { ProductId = 5, Name = "Veggie Enchiladas", Description = "Cheese and roasted vegetable enchiladas with salsa verde, crema, rice, and beans.", Price = 10.99m, Stock = 35, CategoryId = 2, ImageUrl = "/images/menu/veggie-enchiladas.png" },
            new Product { ProductId = 6, Name = "Carne Asada Burrito", Description = "Large flour tortilla filled with steak, rice, beans, cheese, pico, guacamole, and salsa.", Price = 12.49m, Stock = 38, CategoryId = 2, ImageUrl = "/images/menu/carne-asada-burrito.png" },
            ...
            new Product { ProductId = 9, Name = "Chips and Salsa Trio", Description = "Warm tortilla chips with salsa roja, salsa verde, and pico de gallo.", Price = 5.99m, Stock = 80, CategoryId = 1, ImageUrl = "/images/menu/chips-salsa-trio.png" },
            new Product { ProductId = 10, Name = "Mexican Rice", Description = "Savory tomato rice with garlic, onion, and cilantro.", Price = 3.49m, Stock = 90, CategoryId = 3, ImageUrl = "/images/menu/mexican-rice.png" },
            new Product { ProductId = 11, Name = "Refried Beans", Description = "Creamy pinto beans finished with cotija cheese.", Price = 3.49m, Stock = 85, CategoryId = 3, ImageUrl = "/images/menu/refried-beans.png" },
            ...
            new Product { ProductId = 14, Name = "Agua Fresca Flight", Description = "Three small seasonal aguas frescas: jamaica, lime, and horchata.", Price = 5.99m, Stock = 40, CategoryId = 5, ImageUrl = "/images/menu/agua-fresca-flight.png" });
